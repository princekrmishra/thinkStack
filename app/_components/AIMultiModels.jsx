    ...
    <div className='flex flex-1 h-[75vh] border-b'>
        {aiModelList.map((model, index) => (
            <div
                ...
                className={`flex flex-col border-r h-full${model.enable?'flex-1 min-w-[400px]': 
                'w-[100px] flex-none'
                }`}
            >
                ...
                <div className='flex items-center gap-4'>
                   ...
                   {model.enable && 
                   <Select value={aISelectedModels?.[model.model]?.modelId || ""}onValueChange = {(value) => onSelectValue(model.model, value)}
